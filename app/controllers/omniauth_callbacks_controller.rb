class OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def callback_for(provider)
    ...
    # see https://github.com/letsbuildgg/dev.to/blob/27131f6f420df347a467f8e9afc84a6af2fcb13a/app/models/user.rb#L532-L555
    ...
    # https://github.com/letsbuildgg/dev.to/blob/80737b540453afe8775128cb37bd379b7c09c7e8/app/services/authorization_service.rb#L77
    else
