...
you clone the LetsBuild.gg repository and open the project in VS Code, you will
be prompted to install recommended extensions which include the
...
- Once you have your local installation of LetsBuild.gg running, you can attach
  to either the Chrome or Edge Debugger.
...
LetsBuild.gg currently uses Preact 8.x so the Preact developer tools are not an
option, however Preact 8.x+ is compatible with the React developer tools
extension which is available for Chrome and Firefox.
