...
- variables:
  [/app/assets/stylesheets/variables.scss](https://github.com/letsbuildgg/dev.to/blob/master/app/assets/stylesheets/variables.scss)
- mixins:
  [/app/assets/stylesheets/\_mixins.scss](https://github.com/letsbuildgg/dev.to/blob/master/app/assets/stylesheets/_mixins.scss)

SASS is compiled and served using
[Sprockets](https://github.com/rails/sprockets-rails) which packages static
assets in Rails.

For more about branding, theming or design in general in regards to
LetsBuild.gg, refer to the [Design Guide](/design) documentation.
