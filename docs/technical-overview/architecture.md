...
rule, you should avoid relying on JavaScript for layout when working on
LetsBuild.gg.
...
LetsBuild.gg uses a variation of "instant click", via
...
open source project, or any standalone publication on LetsBuild.gg.
