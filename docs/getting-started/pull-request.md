...
If the pull request affects the public API in any way, a post on LetsBuild.gg
from the LetsBuild.gg Team account should accompany it. This is the duty of the
core team to carry out.
