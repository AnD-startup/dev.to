...
# How LetsBuild.gg uses Elasticsearch

### Searchable Models

At LetsBuild.gg we use Elasticsearch for all of our user-facing searching needs.
Models that are searched using Elasticsearch are:
