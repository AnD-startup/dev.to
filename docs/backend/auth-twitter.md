...
LetsBuild.gg allows you to authenticate using Twitter. In order to use this
...
5. Write down the reasons that you want to use Twitter API. Mention
   LetsBuild.gg's community and describe the issues and tests and things that
   you want to work on. Copy it, you might use it later ;)
...
5. Fill in the LetsBuild.gg information, **Terms of Service**
   `http://dev.to/terms` and **Privacy policy** `http://dev.to/privacy`.
