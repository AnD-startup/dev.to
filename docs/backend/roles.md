...
## How do we implement roles in LetsBuild.gg.to?
...
[2]: https://github.com/letsbuildgg/dev.to/blob/master/app/models/role.rb
[3]: https://github.com/letsbuildgg/dev.to/search?q=has_role&unscoped_q=has_role
