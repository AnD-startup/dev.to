...
broadcast_messages = {
  set_up_profile: "Welcome to LetsBuild.gg! 👋 I'm Sloan, the community mascot and I'm here to help get you started. Let's begin by <a href='/settings'>setting up your profile</a>!",
  welcome_thread: "Sloan here again! 👋 LetsBuild.gg is a friendly community. Why not introduce yourself by leaving a comment in <a href='/welcome'>the welcome thread</a>!",
  ...
  customize_feed: "Hi, it's me again! 👋 Now that you're a part of the LetsBuild.gg community, let's focus on personalizing your content. You can start by <a href='/tags'>following some tags</a> to help customize your feed! 🎉",
  customize_experience: "Sloan here! 👋 Did you know that that you can customize your LetsBuild.gg experience? Try changing <a href='settings/ux'>your font and theme</a> and find the best style for you!",
  start_discussion: "Sloan here! 👋 I noticed that you haven't <a href='https://letsbuild.gg/t/discuss'>started a discussion</a> yet. Starting a discussion is easy to do; just click on 'Write a Post' in the sidebar of the tag page to get started!",
  ask_question: "Sloan here! 👋 I noticed that you haven't <a href='https://letsbuild.gg/t/explainlikeimfive'>asked a question</a> yet. Asking a question is easy to do; just click on 'Write a Post' in the sidebar of the tag page to get started!",
  discuss_and_ask: "Sloan here! 👋 I noticed that you haven't <a href='https://letsbuild.gg/t/explainlikeimfive'>asked a question</a> or <a href='https://letsbuild.gg/t/discuss'>started a discussion</a> yet. It's easy to do both of these; just click on 'Write a Post' in the sidebar of the tag page to get started!"
}
