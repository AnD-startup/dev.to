...
RSpec.describe GithubIssue, type: :model, vcr: true do
  let(:url_issue) { "https://api.github.com/repos/letsbuildgg/dev.to/issues/7434" }
  let(:url_pull_request) { "https://api.github.com/repos/letsbuildgg/dev.to/pulls/7653" }
  let(:url_comment) { "https://api.github.com/repos/letsbuildgg/dev.to/issues/comments/621043602" }
  let(:url_not_found) { "https://api.github.com/repos/letsbuildgg/dev.to/issues/0" }
