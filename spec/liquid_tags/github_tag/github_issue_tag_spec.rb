...
RSpec.describe GithubTag::GithubIssueTag, type: :liquid_tag, vcr: true do
  describe "#id" do
    let(:url_issue) { "https://github.com/letsbuildgg/dev.to/issues/7434" }
    let(:url_issue_fragment) { "https://github.com/letsbuildgg/dev.to/issues/7434#issue-604653303" }
    let(:url_pull_request) { "https://github.com/letsbuildgg/dev.to/pull/7653" }
    let(:url_pull_request_issue_fragment) { "https://github.com/letsbuildgg/dev.to/pull/7653#issue-412271322" }
    let(:url_issue_comment) { "https://github.com/letsbuildgg/dev.to/issues/7434#issuecomment-621043602" }
    let(:url_pull_request_comment) { "https://github.com/letsbuildgg/dev.to/pull/7653#issuecomment-622572436" }
    let(:url_not_found) { "https://github.com/letsbuildgg/dev.to/issues/0" }
