FactoryBot.define do
  factory :broadcast do
    ...
    factory :welcome_broadcast do
      ...
      type_of        { "Welcome" }
      processed_html { "Sloan here again! 👋 LetsBuild.gg is a friendly community. Why not introduce yourself by leaving a comment in <a href='/welcome'>the welcome thread</a>!" }
    end
    ...
    factory :customize_ux_broadcast do
      ...
      type_of        { "Welcome" }
      processed_html { "Sloan here! 👋 Did you know that that you can customize your LetsBuild.gg experience? Try changing <a href='settings/ux'>your font and theme</a> and find the best style for you!" }
    end

    factory :customize_feed_broadcast do
      title          { "Welcome Notification: customize_feed" }
      type_of        { "Welcome" }
      processed_html { "Hi, it's me again! 👋 Now that you're a part of the LetsBuild.gg community, let's focus on personalizing your content. You can start by <a href='/tags'>following some tags</a> to help customize your feed! 🎉" }
    end
